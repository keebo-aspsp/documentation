...
As defined further in the KEEBO Open Banking API Specification
...
> The request object used in OIDC flows the aud claim is the issuer url from the KEEBO ASPSP .wellknown endpoint (linked below).
